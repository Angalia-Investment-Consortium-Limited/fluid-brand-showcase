...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-0 right-1/4 w-96 h-96 bg-accent/5 rounded-full blur-3xl animate-float opacity-30"
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 fade-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Comprehensive solutions across diverse industries, delivered with
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-primary via-primary to-accent rounded-3xl p-12 md:p-16 text-primary-foreground shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Let our experts help you achieve your goals with integrated
