...
const About = () => {
  return (
    ...
    >
      ...
      <div
        className="absolute bottom-1/4 left-0 w-96 h-96 bg-accent/5 rounded-full blur-3xl animate-float opacity-30"
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 fade-in-up">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A dynamic and diversified organization dedicated to providing
            comprehensive expert services across key economic sectors.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-card rounded-3xl p-8 md:p-10 shadow-elegant hover-lift border border-border/50">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Rakestar Group seamlessly integrates efficient logistics and
                supply chain management, strategic financial consulting, robust
                legal counsel, cutting-edge Information and Communication
                Technology (ICT) solutions, innovative agribusiness practices,
                responsible mining operations, and professional Government
                Relations.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our core strength lies in our ability to deliver synergistic,
                client-focused solutions that drive growth, enhance efficiency,
                bridge communication barriers, and foster sustainable
                development for businesses and communities worldwide.
              </p>
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          ...
          <Card className="group hover-lift fade-in-up stagger-2 border-2 border-transparent hover:border-primary/50 transition-all duration-300 bg-gradient-to-br from-card to-card/50">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To empower progress and drive sustainable growth for our clients
                and communities by delivering integrated, innovative, and expert
                solutions across diverse industries. We are committed to
                excellence, integrity, and fostering synergistic relationships
                that unlock value and create lasting impact.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover-lift fade-in-up stagger-3 border-2 border-transparent hover:border-primary/50 transition-all duration-300 bg-gradient-to-br from-card to-card/50">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To be the globally recognized and trusted partner for
                transformative solutions, pioneering new standards of excellence
                and integration across logistics, finance, legal, ICT,
                agribusiness, mining, and government relations, thereby shaping
                a more prosperous, interconnected, and sustainable future.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="group hover-lift fade-in-up stagger-4 border-2 border-transparent hover:border-primary/50 transition-all duration-300 bg-gradient-to-br from-card to-card/50">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our philosophy is rooted in the belief that true progress is
                achieved through holistic integrated wisdom, proactive
                partnership, future-focused innovation, principled execution and
                unwavering commitment to purpose-driven positive impact.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="text-center fade-in-up stagger-5">
          ...
          <div className="flex flex-wrap justify-center gap-4 max-w-4xl mx-auto">
            {[
              ...
              <div
                key={value}
                className={`group bg-gradient-to-r from-primary/10 to-primary/5 text-primary px-8 py-4 rounded-full font-medium hover:from-primary hover:to-primary/90 hover:text-primary-foreground transition-all duration-300 fade-in-up stagger-${
                  index + 6
                } hover-lift cursor-default border-2 border-primary/20 hover:border-primary shadow-lg hover:shadow-primary/50`}
              >
                {value}
              </div>
            ))}
