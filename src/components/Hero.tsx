...
import heroImage from "@/assets/sky-scrapper.jpg";

const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0d2768]"
    >
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 leading-relaxed fade-in-up stagger-2 max-w-3xl mx-auto">
            ...
            Finance, Legal, ICT, Agribusiness, Mining, and Government Relations
