...
import { Scale, FileText, Building, Globe, Gavel, Users, ChevronRight, CheckCircle2 } from "lucide-react";
...
const LegalPage = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Ensuring your business meets all regulatory requirements and standards."
    },
    {
      icon: Globe,
      title: "International Law",
      description: "Cross-border legal expertise for international business operations."
    },
    {
      icon: Users,
      title: "Employment Law",
      description: "Comprehensive employment legal services and workplace compliance."
    },
    {
      icon: Scale,
      title: "Contract Law",
      description: "Expert contract drafting, review, and negotiation services."
    }
  ];
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">
              Legal <span className="text-gradient">Expertise</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Professional legal services backed by years of experience and proven results.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-12 text-center">
              Why Choose Our <span className="text-gradient">Legal Services</span>
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Successfully represented clients in thousands of cases with favorable outcomes.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-lg mb-2">International Expertise</h3>
                  <p className="text-muted-foreground">Cross-border legal knowledge spanning multiple jurisdictions and regulatory frameworks.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                <div>
                  <h3 className="font-semibold text-lg mb-2">Client-Focused Approach</h3>
                  <p className="text-muted-foreground">Personalized legal strategies tailored to your specific needs and objectives.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                <div>
                  ...
                  <p className="text-muted-foreground">Round-the-clock legal support when you need it most.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-primary rounded-2xl p-8 md:p-16 text-center text-primary-foreground">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Our experienced legal team is ready to protect your interests and guide you through complex legal matters.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/#contact">
