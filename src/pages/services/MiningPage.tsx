...
import { Pickaxe, Shield, TreePine, Users, Zap, Mountain, ChevronRight, CheckCircle2 } from "lucide-react";
  ...
  const features = [
    {
      ...
      description: "Environmentally responsible mining practices that minimize ecological impact."
    },
    {
      icon: Zap,
      title: "Resource Exploration",
      description: "Advanced geological surveys and resource identification technologies."
    },
    {
      icon: TreePine,
      title: "Environmental Management",
      description: "Comprehensive environmental protection and restoration programs."
    },
    {
      icon: Users,
      title: "Community Development",
      description: "Local community engagement and socio-economic development initiatives."
    },
    {
      icon: Shield,
      title: "Safety Operations",
      description: "World-class safety standards and operational excellence in mining activities."
    },
    {
      icon: Pickaxe,
      title: "Mining Technology",
      description: "State-of-the-art mining equipment and innovative extraction methods."
    }
  ];
      ...
      <div className="bg-muted/30 py-4 border-b">
        <div className="container mx-auto px-6">
          <nav className="flex items-center text-sm text-muted-foreground">
            ...
            <ChevronRight className="w-4 h-4 mx-2" />
            <span className="text-foreground">Mining Operations</span>
          </nav>
        </div>
      </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">
              Responsible <span className="text-gradient">Mining</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Mining operations that balance resource extraction with environmental stewardship and community welfare.
            </p>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-12 text-center">
              Responsible <span className="text-gradient">Mining Excellence</span>
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Committed to minimizing ecological impact and restoring mined areas.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                <div>
                  ...
                  <p className="text-muted-foreground">Creating jobs and supporting local communities through sustainable development.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                <div>
                  ...
                  <p className="text-muted-foreground">World-class safety standards protecting workers and surrounding communities.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <CheckCircle2 className="w-6 h-6 text-primary flex-shrink-0 mt-1" />
                <div>
                  ...
                  <p className="text-muted-foreground">State-of-the-art equipment and innovative extraction methods.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          <div className="bg-gradient-primary rounded-2xl p-8 md:p-16 text-center text-primary-foreground">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Join us in sustainable resource extraction that benefits communities and preserves the environment.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/#contact">
